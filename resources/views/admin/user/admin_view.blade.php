                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control" value="{{$user['employee_id']}}" name='employee_id' id="InputemployeeID" disabled>
                      </div>  
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        権限<select class="form-select" aria-label="権限" name='group_id' id='InputGroup_id' disabled>
                          @if(0==$user['group_id'])
